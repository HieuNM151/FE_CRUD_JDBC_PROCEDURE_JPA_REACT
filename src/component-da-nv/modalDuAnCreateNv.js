...
const ModalDuAnCreateNv = ({ show, handleClose, idda }) => {
    ...
    const handleAddEmployee = (itemId) => {
        const formData = {
            nhanVienId: itemId,
            duAnId: idda
        };
                                ...
                                <tbody>
                                    {emplData?.map((item, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <button onClick={() => handleAddEmployee(item.id)} className="btn btn-outline-info">
...
export default ModalDuAnCreateNv;
