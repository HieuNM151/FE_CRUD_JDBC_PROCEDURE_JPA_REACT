...
const EmpCreateModal = ({ show, handleClose, handleAddEmployeeModal, handleReloadData }) => {
    ...
    const handleValidation = () => {
        if (name.trim() === "" || date.trim() === "" || sdt.trim() === "" || diachi.trim() === ""|| email.trim() === "") {
                            ...
                            <div className="row">
                                <div className="col-lg-6 mb-3">
                                    <div className="from-group">
                                        ...
                                        <input value={email} required onMouseDown={() => setValidationEmail(true)} onChange={(e) => setEmail(e.target.value)} className="form-control"></input>
                                        {email.length === 0 && validationEmail && <span className="text-danger">Email không được để trống</span>}
                                    </div>
                                </div>
                                <div className="col-lg-6 mb-3">
                                    <div className="from-group">
